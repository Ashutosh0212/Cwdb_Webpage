...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { href: '/schemes', label: t('nav.schemes') },
    {
      label: t('nav.media'),
      dropdown: [
        { href: '/media/wool-photos', label: t('nav.media.woolphotos') },
        { href: '/media/wool-success-stories', label: t('nav.media.successStories') },
        { href: '/media/important-events', label: t('nav.media.importantevents') },
      ],
    },
    ...
    { href: '/rti', label: t('nav.rti') },
    {
      ...
      dropdown: [
        { href: '/documents/oomf', label: t('nav.documents.oomf') },
        { href: '/documents/tender-notice', label: t('nav.documents.tender') },
        { href: '/documents/tenders-of-ia', label: t('nav.documents.tenderia') },
        { href: '/documents/annual-reports', label: t('nav.documents.annualreports') },
        { href: '/documents/other-important-reports', label: t('nav.documents.importantreports') },
      ],
    },
